...
const BrandPanel = () => (
  <div
    className="relative hidden md:flex w-[45%] min-h-screen flex-col justify-between overflow-hidden p-12"
    style={{
      background:
  ...
  >
    ...
    <div
      className="absolute pointer-events-none rounded-full animate-float-1"
      style={{
        width: 400,
        height: 400,
        top: -100,
    ...
    />
    <div
      className="absolute pointer-events-none rounded-full animate-float-2"
      style={{
        width: 300,
        height: 300,
        bottom: 50,
    ...
    />
    <div
      className="absolute pointer-events-none rounded-full animate-float-3"
      style={{
        width: 200,
        height: 200,
        top: "40%",
    ...
    <div className="relative z-10">
      ...
      <p className="text-base text-white/75 leading-relaxed mb-10 max-w-sm">
        Services, marketplace, transport & lost items — all in one place built
        for ESTIN students.
      </p>
    ...
    <div className="relative z-10 flex items-center gap-3">
      ...
      <span className="text-sm text-white/85">
        Join 200+ ESTIN students already using the platform
      </span>
    </div>
  </div>
);
